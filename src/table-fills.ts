...
export type CellFill = '' | 'gray' | 'gray-dark' | 'yellow' | 'blue';
...
// gray #f0f0f0 (= luma(240)), gray-dark #dcdcdc (= luma(220)),
// yellow #fff3b0, blue #e6f0ff.
...
export function cellFillFromTypst(expr: string): Exclude<CellFill, ''> | null {
  ...
  if (/^rgb\(["']#dcdcdc["']\)$/i.test(wanted)) return 'gray-dark';
